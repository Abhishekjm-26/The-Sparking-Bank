      ...
      <!-- Introduction section -->
            <div class="row intro py-1">
              ...
              <div class="col-sm-12 col-md img text-center">
                <img src="img/bank.png" class="img-fluid pt-2" style="width: 400px;">
              </div>
            </div>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  ...
                  <div class="col-md act">
                    ...
                    <br>
                    <a href="transfermoney.php"><button>Make a new Transaction</button></a>
                  </div>
                  <div class="col-md act">
                    <img src="img/history.jpg" class="img-fluid">
                    <br>
                    <a href="transactionhistory.php"><button>Your Transaction History</button></a>
                  </div>
            </div>
      </div>
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made with &hearts; by <b>ABHISHEK J M</b> <br> The Sparks Foundation - Web Development Intern</p>
      </footer>
